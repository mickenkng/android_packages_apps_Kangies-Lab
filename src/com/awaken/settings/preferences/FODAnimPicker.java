...
package com.awaken.settings.preferences;
...
public class FODAnimPicker extends LayoutPreference {
    ...
    private void setView(View view, Context context) {
        ...
        Button9 = findViewById(R.id.fodanim9_button);
        Button10 = findViewById(R.id.fodanim10_button);
        Button11 = findViewById(R.id.fodanim11_button);
        Button12 = findViewById(R.id.fodanim12_button);
        Button13 = findViewById(R.id.fodanim13_button);
        Button14 = findViewById(R.id.fodanim14_button);
        Button15 = findViewById(R.id.fodanim15_button);
        Button16 = findViewById(R.id.fodanim16_button);
        Button17 = findViewById(R.id.fodanim17_button);
        Button18 = findViewById(R.id.fodanim18_button);
        Button19 = findViewById(R.id.fodanim19_button);
        Button20 = findViewById(R.id.fodanim20_button);
        Button21 = findViewById(R.id.fodanim21_button);
        Button22 = findViewById(R.id.fodanim22_button);
        Button23 = findViewById(R.id.fodanim23_button);
